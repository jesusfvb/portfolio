    ...
    >
      ...
      >
        ...
        <div className="flex flex-col md:flex-row max-h-[90vh] overflow-hidden">
          ...
          <div className={`flex-1 overflow-y-auto ${hasImages ? 'md:max-h-[90vh]' : ''}`}>
              ...
              <div className="flex flex-wrap gap-4">
                {project.link && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-[#6366f1] to-[#8b5cf6] text-white rounded-lg font-semibold transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_30px_rgba(99,102,241,0.4)] no-underline"
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                {project.githubBackend && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-[#121212] border border-[rgba(255,255,255,0.1)] text-white rounded-lg font-semibold transition-all duration-300 hover:bg-[#1a1a1a] hover:border-[#6366f1] no-underline ml-6"
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                    </svg>
