      ...
      <div className="container">
        ...
        <div className="mx-auto mt-12 max-w-2xl">
          <h3 className="mb-4 text-center text-2xl font-semibold text-white">
            {t("contactSection.connectTitle")}
          </h3>
          <p className="mb-8 text-center leading-relaxed text-[#d0d0d0]">
            {t("contactSection.connectMessage")}
          </p>
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              aria-label={t("contactSection.sendEmailAria")}
              title={t("contactSection.sendEmailTitle")}
            >
